...
CONFIG_FILE=work_dirs/buildings_09_27_ocrnet/ocrnet_hr48_512x512_160k_building_addtk.py
...
work_dir=work_dirs/buildings_09_27_ocrnet
...
python tools/test.py ${CONFIG_FILE} \
    ${CHECKPOINT_FILE} \
    --cfg-options data.test.data_root=${tmpdir} data.test.img_dir=${crop_img}  data.test.classes=${clsname} data.test.img_suffix=${img_suffix} \
    --show-dir ${crop_seg}
